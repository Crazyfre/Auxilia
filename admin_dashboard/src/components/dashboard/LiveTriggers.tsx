    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      ...
      <div className="space-y-4">
        {triggers.map((trigger, index) => {
          ...
          const colors = colorMap[trigger.type as keyof typeof colorMap] ?? colorMap.accident;
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-slate-900 capitalize">{trigger.type} - {trigger.zone}</p>
                ...
                <div className="text-right">
                  ...
                  {trigger.isActive && (
                    <p className="text-xs text-orange-600">{trigger.affectedPolicies ?? 0} policies affected</p>
                  )}
                </div>
              </div>
              <div className="mt-3">
